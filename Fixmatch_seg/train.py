...
def main(config, resume):
    ...
    supervised_loader = dataloaders.ROB(config['train_supervised'])
    unsupervised_loader = dataloaders.ROB(config['train_unsupervised'])
    val_loader = dataloaders.ROB(config['val_loader'])
